...
const data = [
  ...
  { label: "Malindi", value: "MALINDI", id: 4 },
  { label: "Homabay", value: "HOMABAY", id: 5 },
  { label: "Busia", value: "BUSIA", id: 6 },
  { label: "Kisumu", value: "KISUMU", id: 7 },
  { label: "Kakamega", value: "KAKAMEGA", id: 8 },
];
const datas = [
  { labels: "Nairobi", values: "NAIROBI", id: 1 },
  { labels: "Mombasa", values: "MOMBASA", id: 2 },
  { labels: "Kericho", values: "KERICHO", id: 3 },
  { labels: "Malindi", values: "MALINDI", id: 4 },
  { labels: "Homabay", values: "HOMABAY", id: 5 },
  { labels: "Busia", values: "BUSIA", id: 6 },
  { labels: "Kisumu", values: "KISUMU", id: 7 },
  { labels: "Kakamega", values: "KAKAMEGA", id: 8 },
];
    ...
    <SafeAreaProvider className="mt-8">
      ...
      <View className="justify-center items-center px-5 py-16">
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.navigate("Available", { param1: value, param2: values })
          }
        >
