    ...
    <SafeAreaView>
      ...
      <View className="flex-row py-5 justify-evenly">
        <Image
          ...
          className="h-6 w-6"
        />
        <Text className="py-3">Availabe seats</Text>

        <Image
          source={require("../assets/bookedseat.png")}
          className="h-6 w-6"
        />
        <Text className="py-3">Booked seats</Text>

        <Image
          source={require("../assets/selectedseat.png")}
          className="h-6 w-6"
        />
        <Text className="py-3">Selected seats</Text>
      </View>
      ...
      <View className="flex-row px-16">
        <Text className="text-2xl font-bold py-2 text-blue-600">Seats:</Text>
        <Text className="text-2xl font-bold py-2 left-36 text-blue-600">
          Amount: 0
        </Text>
      </View>

      <View className="flex-row px-16 py-5">
        <Text className="text-xl py-5">Boarding point: </Text>
        <View className="left-20 border border-blue-600 rounded-xl ">
          <Text className="p-4 text-xl font-semibold">NAIROBI</Text>
        </View>
      </View>

      
        <TouchableOpacity className="bg-blue-900 items-center h-16 w-90 py-1 rounded-3xl">
          <Text className="text-white font-semibold text-2xl py-3">Fill Passenger Details</Text>
        </TouchableOpacity>
